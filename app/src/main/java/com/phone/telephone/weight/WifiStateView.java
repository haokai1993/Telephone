package com.phone.telephone.weight;
...
public class WifiStateView extends AppCompatImageView {
    ...
    private static class WifiHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case LEVEL_1:
                    wifiStateView.setImageResource(R.mipmap.ic_wifi_one);
                    break;
                case LEVEL_2:
                    wifiStateView.setImageResource(R.mipmap.ic_wifi_two);
                    break;
                case LEVEL_3:
                    wifiStateView.setImageResource(R.mipmap.ic_wifi_three);
                    break;
                case LEVEL_4:
                    wifiStateView.setImageResource(R.mipmap.ic_wifi_four);
                    break;
                case LEVEL_NONE:
                default:
                    wifiStateView.setImageResource(R.mipmap.icon_wifi_note);
                    break;
            }
        }
    }
